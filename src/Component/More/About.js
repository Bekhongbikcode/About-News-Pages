...
function About() {
    return (
        <div>
            <div className='row' style={{ display: "flex", flexWrap: "wrap", marginLeft: "5px", marginRight: "50px" }}>
                <div className='col s6' >
                    ...
                    <p style={{ fontSize: "2.125rem", maxWidth: "100%", paddingBottom: "0", fontFamily: "Mont,sans-serif", marginBlockStart: "1em", marginBlockEnd: "1em", marginInlineStart: "0px", marginInlineEnd: "0px", marginTop: "25px" }}>Our mission is to change the way the world parks</p>
            ...
            <div className='container'>
                ...
                <p style={{ fontSize: "2.125rem", maxWidth: "100%", paddingBottom: "0", fontFamily: "Mont,sans-serif", marginBlockStart: "1em", marginBlockEnd: "1em", marginInlineStart: "0px", marginInlineEnd: "0px", textAlign: "center" }}>A world where parking is seamlessly integrated into our travels through the use of smart technology.
                </p>
            ...
            <div className='row' style={{ marginBottom: "20%", marginTop: "5%", marginLeft: "100px" }}>
                ...
                <div className='col s6' style={{ backgroundColor: "#2dc98bbe", marginLeft: "23%", height: "571px", width: "800px" }}>
                    <div style={{ marginLeft: "100px", marginLeft: "200px", marginTop: "13%" }}>
                        ...
                        <button className='btn' type="submit" style={{ backgroundColor: "#101921", borderRadius: "5%", border: "none", color: "white" }}> Join Us</button>
                    </div>
                </div>
            </div>
            <Footer />
