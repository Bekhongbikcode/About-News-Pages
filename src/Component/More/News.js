    ...
    return (
        <div>
            ...
            <div className='row' style={{ backgroundColor: "#2dc98a" }}>
                <h2 style={{ textAlign: "center", marginTop: "15%", marginBottom: "6%", color: "white", paddingTop: "5%", fontWeight: "bold" }}>Our Investor</h2>
                <Card className='col s3 onhover' style={{ marginRight: "50px", marginLeft: "7%", height: "350px", width: "25%" }}>
                    ...
                    <p style={{ textAlign: 'center' }}>Parking lots specifically for bicycles are becoming more prevalent in many countries. These may include bicycle parking racks and locks and modern.</p>
                </Card>
                <Card className='col s3 onhover' style={{ marginRight: "50px", height: "350px" }}>
                ...
                <Card className='col s3 onhover' style={{ height: "350px", width: "30%" }}>
                ...
                <p style={{ textAlign:"center",color: "#4a697c", fontFamily: "Brush Script MT, sans-serif", opacity: ".15", fontSize: "50px", marginTop: "-30px", marginBottom: "0", paddingBottom:"50px", marginLeft:"75%" }}>
                    CarParkingPage
                </p>
            </div>
